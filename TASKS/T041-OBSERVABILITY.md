# T041-OBSERVABILITY.md

## Objective
Add structured logs, request IDs, analysis IDs, health checks, latency measurements, and provider failure visibility without logging private content.
