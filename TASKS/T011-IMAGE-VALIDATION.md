# T011-IMAGE-VALIDATION.md

## Objective
Harden image validation against malformed files, decompression bombs, spoofed MIME types, oversized payloads, and unsafe filenames.
