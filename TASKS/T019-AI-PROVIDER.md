...
## Objective
Create an AI detector provider interface, provider configuration, normalized result schema, error handling, caching hooks, and a mock provider for development.
