...
## Objective
Bootstrap the monorepo with Next.js web, FastAPI API, shared types, Python tooling, TypeScript tooling, linting, formatting, and basic CI. Verify local startup for web and API.
