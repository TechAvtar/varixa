# T021-PROVIDER-LOGGING.md

## Objective
Implement provider_calls persistence including provider, operation, status, latency, model/version, request hash, estimated cost, raw response, and error.
